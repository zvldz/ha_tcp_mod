...
CONF_SEND_EOL = "send_eol"

DEFAULT_BUFFER_SIZE = 1024
DEFAULT_NAME = "TCP_MOD Sensor"
DEFAULT_TIMEOUT = 10
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(CONF_SEND_EOL, default=False): cv.boolean,
    }
)
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    add_entities([TcpModSensor(hass, config)])


class TcpModSensor(Entity):
